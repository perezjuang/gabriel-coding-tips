...
@Configuration
public class GabrielServiceInstanceEventFlowsConfiguration {
	...
	public GabrielServiceInstanceEventFlowsConfiguration(CreateServiceInstanceEventFlowRegistry createRegistry,
